// PvP Plugin created by Venk and Sirvoid with help from MegaPVP
...
namespace MCGalaxy {
    public class PvP : Plugin_Simple {
		...
		bool economy = true; // Enable (true) or disable (false) rewards when killing someone
		int moneyStolen = 3; // If economy = true, money stolen when you kill someone
